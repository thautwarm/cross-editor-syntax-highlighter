...
exports.SHLexer = void 0;
const ATNDeserializer_1 = require("antlr4ts/atn/ATNDeserializer");
const Lexer_1 = require("antlr4ts/Lexer");
const LexerATNSimulator_1 = require("antlr4ts/atn/LexerATNSimulator");
const VocabularyImpl_1 = require("antlr4ts/VocabularyImpl");
const Utils = require("antlr4ts/misc/Utils");
class SHLexer extends Lexer_1.Lexer {
    // tslint:enable:no-trailing-whitespace
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(SHLexer._ATN, this);
    }
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    // @Override
    get ruleNames() { return SHLexer.ruleNames; }
    // @Override
    get serializedATN() { return SHLexer._serializedATN; }
    // @Override
    get channelNames() { return SHLexer.channelNames; }
    // @Override
    get modeNames() { return SHLexer.modeNames; }
    static get _ATN() {
        if (!SHLexer.__ATN) {
            SHLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(SHLexer._serializedATN));
        }
        return SHLexer.__ATN;
    }
}
exports.SHLexer = SHLexer;
SHLexer.T__0 = 1;
SHLexer.T__1 = 2;
SHLexer.T__2 = 3;
SHLexer.T__3 = 4;
...
SHLexer.STR = 18;
SHLexer.SPACE = 19;
SHLexer.LINE_COMMENT = 20;
SHLexer.ID = 21;
// tslint:disable:no-trailing-whitespace
SHLexer.channelNames = [
...
SHLexer._LITERAL_NAMES = [
    undefined, "'format'", "'=='", "'!='", "'>'", "'<'", "'>='", "'<='", "'~'",
    "'^'", "'&&'", "'true'", "'false'", "'null'", "'{'", "'}'",
];
SHLexer._SYMBOLIC_NAMES = [
    undefined, undefined, undefined, undefined, undefined, undefined, undefined,
    undefined, undefined, undefined, undefined, undefined, undefined, undefined,
    undefined, undefined, "VERSION", "EXP", "STR", "SPACE", "LINE_COMMENT",
    "ID",
];
SHLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(SHLexer._LITERAL_NAMES, SHLexer._SYMBOLIC_NAMES, []);
SHLexer._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x17\xAE\b\x01" +
...
//# sourceMappingURL=SHLexer.js.map