...
def codegen(analyzer: Analyzer, cg_options: CodeGenOptions, lang_name: str, stmts: List[definition]) -> List[Tuple[str, Doc]]:
    ...
    def arrow_137(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
                    ...
                    def arrow_133(_unit=None) -> Iterable[Doc]:
                        def arrow_132(_unit=None) -> Iterable[Doc]:
                            ...
                            def arrow_131(_unit=None) -> Iterable[Doc]:
                                def arrow_130(match_value_9: Tuple[str, Shape]) -> Iterable[Doc]:
                                    ...
                                    return append_2(singleton_1(Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(word(to_text(interpolate("public partial record %P()", [typename_0027_1]))), word(tparams_2)), func_params_1), word(";"))), delay(arrow_129))
                                
                                return append_2(collect(arrow_130, Sigma__GetRecordTypes(analyzer.Sigma)), delay(lambda _unit=None: singleton_1(word("}"))))
                            
                            return append_2(collect(arrow_122, adt_cases), delay(arrow_131))
                        
                        return append_2(singleton_1(word(to_text(interpolate("namespace %P(){", [lang_name])))), delay(arrow_132))
                    
                    return append_2(singleton_1(empty_2), delay(arrow_133))
                
                return append_2(singleton_1(word("using System;")), delay(arrow_134))
            
            return append_2(singleton_1(word("using System.Collections.Generic;")), delay(arrow_135))
        
        return append_2(singleton_1(word("using Antlr4.Runtime;")), delay(arrow_136))
    
    file_constructors : Tuple[str, Doc] = (to_text(interpolate("%P().Constructor.", [lang_name])) + ".cs", vsep(to_list(delay(arrow_137))))
    ...
    if match_value_12 is not None:
        ...
        def cg_stmt(stmt: definition, analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Doc:
            ...
            if stmt.tag == 2:
                ...
                idx_1 : int = 0
                def arrow_166(stmt: definition=stmt) -> Iterable[Doc]:
                    def arrow_164(match_value_4: Tuple[position, production_1]) -> Iterable[Doc]:
                        ...
                        def arrow_162(_unit=None) -> Doc:
                            ...
                            used_slots : Any = empty_4(ObjectExpr140())
                            def cg_expr(scope_1: FSharpList[Tuple[str, str]], curr_expr_1: expr) -> DocBuilder_block_1[Doc]:
                                def arrow_156(scope_1: FSharpList[Tuple[str, str]]=scope_1, curr_expr_1: expr=curr_expr_1) -> DocBuilder_block_1[Doc]:
                                    nonlocal used_slots
                                    ...
                                    if match_value_1.tag == 6:
                                        ...
                                        if match_value_2 is not None:
                                            ...
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, word(v_1) if (length(match_value_1.fields[1].contents) == 0) else (arrow_141()))
                                        ...
                                        return DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_145())
                                    
                                    elif match_value_1.tag == 4:
                                        def arrow_148(_arg7: Doc) -> DocBuilder_block_1[Doc]:
                                        ...
                                        return DocBuilder_Builder__Bind_30A200B3(DocBuilder_cg, cg_expr(scope_1, match_value_1.fields[1]), arrow_148)
                                        ...
                                        def arrow_155(_arg2_1: Doc) -> DocBuilder_block_1[Doc]:
                                            def arrow_154(_unit=None) -> DocBuilder_block_1[FSharpList[Doc]]:
                                                def arrow_153(_arg3: expr) -> DocBuilder_block_1[Doc]:
                                                    arg : expr = _arg3
                                                ...
                                                return DocBuilder_Builder__For_2B96F4AF(DocBuilder_cg, match_value_1.fields[1], arrow_153)
                                            
                                            return DocBuilder_Builder__Bind_30A200B3(DocBuilder_cg, DocBuilder_Builder__Run_ZD0BB270(DocBuilder_cg, DocBuilder_Builder__Delay_Z3A9C5A06(DocBuilder_cg, arrow_154)), lambda _arg5: DocBuilder_Builder__Return_1505(DocBuilder_cg, Doc_op_Addition_Z7CFFAC00(word(to_text(interpolate("(%P())", [cg_type(curr_expr_1.t)]))), Doc_op_Multiply_Z7CFFAC00(_arg2_1, parens(seplist(word(", "), _arg5))))))
                                        
                                        return DocBuilder_Builder__Bind_30A200B3(DocBuilder_cg, DocBuilder_Builder__Run_ZD0BB270(DocBuilder_cg, DocBuilder_Builder__Delay_Z3A9C5A06(DocBuilder_cg, lambda _unit=None: DocBuilder_Builder__For_2B96F4AF(DocBuilder_cg, match_value_1.fields[0], lambda _arg10: DocBuilder_Builder__ReturnFrom_ZD0BB270(DocBuilder_cg, cg_expr(scope_1, _arg10))))), lambda _arg11: DocBuilder_Builder__Return_1505(DocBuilder_cg, parens(seplist(word(", "), _arg11)))) if (match_value_1.tag == 1) else (DocBuilder_Builder__Bind_30A200B3(DocBuilder_cg, cg_expr(scope_1, match_value_1.fields[0]), arrow_155))
                                    
                                
                                return DocBuilder_Builder__Run_ZD0BB270(DocBuilder_cg, DocBuilder_Builder__Delay_Z3A9C5A06(DocBuilder_cg, arrow_156))
                            ...
                            return Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(arrow_161(), word("{")), Doc_op_RightShift_2AAA0F3C(vsep(of_array_1([empty_2, Doc_op_RightShift_2AAA0F3C(vsep(of_array_1([vsep(pattern_input_1[1][1]), Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word("$" + result_name), word("=")), Doc_op_Multiply_Z7CFFAC00(pattern_input_1[1][0], word(";")))])), 4), word("}")])), 12))
                        ...
                        return append_2(singleton_1(arrow_162()), delay(arrow_163))
                    
                    return collect(arrow_164, decl["define"])
                
                body_3 : Doc = align(vsep(map_indexed(lambda i_10, e_1, stmt=stmt: Doc_op_Addition_Z7CFFAC00(word(":") if (i_10 == 0) else (word("|")), e_1), to_list(delay(arrow_166)))))
        ...
        def arrow_177(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
            def arrow_176(match_value_13: Tuple[str, lexerule]) -> Iterable[Doc]:
            ...
            return collect(arrow_176, reverse(lexer_maps))
        
        lexer_defs : FSharpList[Doc] = to_list(delay(arrow_177))
        start_mangled : str = cg_symbol(symbol(1, "start"))
        def arrow_186(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
            def arrow_185(_unit=None) -> Iterable[Doc]:
                def arrow_184(_unit=None) -> Iterable[Doc]:
                    def arrow_183(_unit=None) -> Iterable[Doc]:
                        def arrow_179(match_value_14: Tuple[str, str, str, FSharpList[Tuple[Doc, Doc]], Doc]) -> Iterable[Doc]:
                        ...
                        def arrow_182(_unit=None) -> Iterable[Doc]:
                            def arrow_181(_unit=None) -> Iterable[Doc]:
                                ...
                                return append_2(singleton_1(word(arrow_180())), delay(lambda _unit=None: append_2(singleton_1(file_grammar), delay(lambda _unit=None: lexer_defs))))
                            
                            return append_2(singleton_1(word("}")), delay(arrow_181))
                        
                        return append_2(collect(arrow_179, doc_ctor_wrap_funcs), delay(arrow_182))
                    
                    return append_2(singleton_1(word("@members {")), delay(arrow_183))
                
                return append_2(singleton_1(word("options { language = CSharp; }")), delay(arrow_184))
            
            return append_2(singleton_1(word(to_text(interpolate("grammar %P();", [lang_name])))), delay(arrow_185))
        
        return [(lang_name + ".g4", vsep(to_list(delay(arrow_186)))), file_constructors]
